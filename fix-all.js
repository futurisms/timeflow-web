...
console.log('Fixing Timeflow files...');
...
fs.writeFileSync(path.join('app', 'api', 'generate-wisdom', 'route.ts'), apiRoute);
...
fs.writeFileSync(path.join('app', 'lens-selection', 'page.tsx'), lensPage);
console.log('✓ Fixed lens selection page');

console.log('\nAll files fixed! Restart your dev server.');
