            ...
            {filteredCards.map((card) => (
              ...
              >
                ...
                <button
                  ...
                  className="absolute top-4 right-4 bg-white/20 hover:bg-white/30 p-2 rounded-full transition-all opacity-0 group-hover:opacity-100"
                  title="Delete card"
                >
                  {deletingId === card.id ? (
                ...
                <div className="flex items-center justify-between text-xs opacity-75">
                  ...
                  <button
                    onClick={() => {
                      // Future: view full card modal
                      alert('Full card view coming soon!');
                    }}
